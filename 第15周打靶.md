...
- 靶机地址：https://download.vulnhub.com/ripper/Ripper.ova
  ...
  <img src="/15-1.png" alt="15-1" style="zoom:50%;" />
...
- 查询PHP源码中的敏感信息
  ...
  - 既然已经获取到了静态扫描控制台，那就可以直接扫描一波这个项目本身。代码本身确实是有漏洞![15-4](/15-4.png)
...
- 查看内核版本 
  ...
  - 编译后获得了 exp，scp到目标机器，./exp 执行，接获得了root权限。 ![15-6](/15-6.png)
